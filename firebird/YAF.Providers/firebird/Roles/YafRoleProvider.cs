...
namespace YAF.Providers.Roles
{
  ...
  public class VzfFirebirdRoleProvider : RoleProvider
  {
    ...
    public override void AddUsersToRoles(string[] usernames, string[] roleNames)
    {
      ...
      foreach (string username in usernames)
      {
        ...
        foreach (string roleName in roleNames)
        {
          ...
          {
              FbDB.Current.AddUserToRole( this.ApplicationName, username, roleName);
          }
        }
    ...
    public override void CreateRole(string roleName)
    {
      ...
      FbDB.Current.CreateRole( this.ApplicationName, roleName);
    }
    ...
    {
        int returnValue = FbDB.Current.DeleteRole( this.ApplicationName, roleName, throwOnPopulatedRole);
    ...
    {
      // get all roles...
        DataTable roles = FbDB.Current.GetRoles( this.ApplicationName, null);
    ...
    public override string[] GetRolesForUser(string username)
    {
      ...
      if (!this.UserRoleCache.ContainsKey(username.ToLower()))
      {
        ...
        DataTable roles = FbDB.Current.GetRoles( this.ApplicationName, username);
    ...
    {
        DataTable roles = FbDB.Current.IsUserInRole( this.ApplicationName, username, roleName);
    ...
    public override void RemoveUsersFromRoles(string[] usernames, string[] roleNames)
    {
      ...
      foreach (string username in usernames)
      {
        ...
        foreach (string roleName in roleNames)
        {
            FbDB.Current.RemoveUserFromRole( this.ApplicationName, username, roleName); // Remove role
    ...
    {
      // get this role...
        object exists = FbDB.Current.GetRoleExists( this.ApplicationName, roleName);
