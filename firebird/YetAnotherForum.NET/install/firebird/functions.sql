 ...
 */
CREATE  PROCEDURE objQual_forum_posts(I_FORUMID integer) 
...
CREATE  PROCEDURE objQual_FORUM_TOPICS(I_FORUMID integer)
...
CREATE  PROCEDURE objQual_FORUM_LASTTOPIC 
...
CREATE  PROCEDURE objQual_MEDAL_GETRIBBONSETTINGS
(
...
CREATE  PROCEDURE objQual_MEDAL_GETSORTORDER
(
...
CREATE  PROCEDURE objQual_MEDAL_HIDE
(
	I_HIDE BOOL,
	I_FLAGS integer
)
...
CREATE  PROCEDURE objQual_GET_USERSTYLE
(	
	I_USERID integer
)
...
CREATE PROCEDURE  objQual_MESSAGE_GETTHANKSINFO
(
I_MESSAGEID  INT,
...
CREATE PROCEDURE  objQual_FORUM_SAVE_PARENTSCHECKER(I_FORUMID INTEGER, I_PARENTID INTEGER)
