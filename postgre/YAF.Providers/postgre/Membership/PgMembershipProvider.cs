  ...
  public class PgMembershipProvider : MembershipProvider
  {
      ...
      string username, string password, string newPasswordQuestion, string newPasswordAnswer)
    {
      ...
      if (currentPasswordInfo.IsCorrectPassword(password))
      {
        try
        {
            DB.Current.__ChangePasswordQuestionAndAnswer(  
    ...
    public override bool DeleteUser(string username, bool deleteAllRelatedData)
    {
      ...
      try
      {
          DB.Current.__DeleteUser(   this.ApplicationName, username, deleteAllRelatedData);
      ...
      string emailToMatch, int pageIndex, int pageSize, out int totalRecords)
    {
      ...
      foreach (DataRow dr in DB.Current.__FindUsersByEmail(   this.ApplicationName, emailToMatch, pageIndex, pageSize).Rows)
      {
      ...
      string usernameToMatch, int pageIndex, int pageSize, out int totalRecords)
    {
      ...
      // Loop through all users
      foreach (DataRow dr in DB.Current.__FindUsersByName(this.ApplicationName, usernameToMatch, pageIndex, pageSize).Rows)
      {
        // Add new user to collection
        users.Add(this.UserFromDataRow(dr));
      }
    ...
    public override MembershipUserCollection GetAllUsers(int pageIndex, int pageSize, out int totalRecords)
    {
      ...
      // Loop through all users
      foreach (DataRow dr in DB.Current.__GetAllUsers(   this.ApplicationName, pageIndex, pageSize).Rows)
      {
        // Add new user to collection
        users.Add(this.UserFromDataRow(dr));
      }
    ...
    {
        return DB.Current.__GetNumberOfUsersOnline(   this.ApplicationName, Membership.UserIsOnlineTimeWindow);
    }
    ...
    public override MembershipUser GetUser(string username, bool userIsOnline)
    {
      ...
      DataRow dr = DB.Current.__GetUser(   this.ApplicationName, null, username, userIsOnline);
    ...
    public override MembershipUser GetUser(object providerUserKey, bool userIsOnline)
    {
      ...
      DataRow dr = DB.Current.__GetUser(   this.ApplicationName, providerUserKey, null, userIsOnline);
    ...
    public override string GetUserNameByEmail(string email)
    {
      ...
      DataTable users = DB.Current.__GetUserNameByEmail(   this.ApplicationName, email);
    ...
    public override bool UnlockUser(string userName)
    {
      ...
      try
      {
          DB.Current.__UnlockUser(   this.ApplicationName, userName);
        return true;
      }
      catch
      {
    ...
    public override void UpdateUser(MembershipUser user)
    {
      ...
      // Update User
      int updateStatus = DB.Current.__UpdateUser(   this.ApplicationName, user, this.RequiresUniqueEmail);
