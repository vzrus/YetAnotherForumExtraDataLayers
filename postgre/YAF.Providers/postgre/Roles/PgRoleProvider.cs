...
namespace YAF.Providers.Roles
{
  ...
  public class PgRoleProvider : RoleProvider
  {
    ...
    public override void AddUsersToRoles(string[] usernames, string[] roleNames)
    {
      ...
      foreach (string username in usernames)
      {
        ...
        foreach (string roleName in roleNames)
        {
          ...
          {
              DB.Current.__AddUserToRole(   this.ApplicationName, username, roleName);
          }
        }
    ...
    public override void CreateRole(string roleName)
    {
      ...
      DB.Current.__CreateRole(   this.ApplicationName, roleName);
    }
    ...
    {
        int returnValue = DB.Current.__DeleteRole(   this.ApplicationName, roleName, throwOnPopulatedRole);
    ...
    public override string[] FindUsersInRole(string roleName, string usernameToMatch)
    {
      ...
      // Roles
      DataTable users = DB.Current.__FindUsersInRole(   this.ApplicationName, roleName);
    ...
    {
      // get all roles...
        DataTable roles = DB.Current.__GetRoles(   this.ApplicationName, null);
    ...
    public override string[] GetRolesForUser(string username)
    {
      ...
      if (!this.UserRoleCache.ContainsKey(username.ToLower()))
      {
        ...
        DataTable roles = DB.Current.__GetRoles(   this.ApplicationName, username);
    ...
    {
        DataTable roles = DB.Current.__IsUserInRole(   this.ApplicationName, username, roleName);
    ...
    public override void RemoveUsersFromRoles(string[] usernames, string[] roleNames)
    {
      ...
      foreach (string username in usernames)
      {
        ...
        foreach (string roleName in roleNames)
        {
            DB.Current.__RemoveUserFromRole(   this.ApplicationName, username, roleName); // Remove role
    ...
    {
      // get this role...
        object exists = DB.Current.__GetRoleExists(   this.ApplicationName, roleName);
